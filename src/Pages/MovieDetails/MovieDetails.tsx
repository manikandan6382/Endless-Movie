...
const MovieDetails = () => {
  ...
  const validType = (type === 'movie' || type === 'tv') ? type as 'movie' | 'tv' : 'movie';
  const { banner, duration, cast, videos, similarMovies, loading, error } = useMovieDetails(validType, id);
